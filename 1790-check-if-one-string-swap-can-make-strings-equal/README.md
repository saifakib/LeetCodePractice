...
<pre style="position: relative;"><strong>Input:</strong> s1 = "bank", s2 = "kanb"
...
<pre style="position: relative;"><strong>Input:</strong> s1 = "attack", s2 = "defend"
...
<pre style="position: relative;"><strong>Input:</strong> s1 = "kelb", s2 = "kelb"
<strong>Output:</strong> true
